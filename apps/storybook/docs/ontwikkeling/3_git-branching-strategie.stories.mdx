...
import uigBranching from '../../resources/ontwikkeling/Git Branching Strategie - UIG.png';
import teamBranching from '../../resources/ontwikkeling/Git Branching Strategie - Teams.png';
