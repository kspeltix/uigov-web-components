...
import cbTestPiramide from '../../resources/testing/component-bibliotheek-test-piramide.png';

<Meta title="Testing/Test Piramide Component Bibliotheek"/>
...
[klassieke test piramide](/story/testing-klassieke-test-piramide--page) en is een variant op de
[SPA test piramide](/story/testing-test-piramide-ssr-vs-spa--page#testen-van-een-spa).
