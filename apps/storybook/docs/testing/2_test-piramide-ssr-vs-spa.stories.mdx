...
import ssrVsSpa from '../../resources/testing/ssr-vs-spa.png';
import ssrTestPiramide from '../../resources/testing/ssr-test-piramide.png';
import spaTestPiramide from '../../resources/testing/spa-test-piramide.png';

<Meta title="Testing/Test Piramide SSR vs SPA"/>
...
als (beperkt) het unhappy pad moeten testen. Logica zal zich eerder in de java code bevinden, niet alle varianten van
