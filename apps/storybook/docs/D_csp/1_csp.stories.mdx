...
<Meta title="CSP/Content Security Protocol"/>
...
- voor externe componenten moet geëvalueerd worden hoe we ze CSP compliant gewijs kunnen gebruiken, 2 belangrijke zijn
